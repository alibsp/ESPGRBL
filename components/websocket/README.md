     ...
     "protocol-old.cpp" "serial.cpp" "main.cpp" "probe.cpp" "esp32-hal-matrix.c" "esp32-hal-uart.c" "jog.cpp" "WString.cpp" "HardwareSerial.cpp" "motion_control.cpp" "EEPROM.cpp" "serial2socket.cpp"
                            "grbl_eeprom.cpp" 
